...
<html>
  <head>
    ...
    <title>Atlanta Beltline - Staff</title>
    ...
    <div class="container">
        <div class="card card-container">
            <form class="form-signin">
                <h4 class="text-center">Welcome Staff<h4/><h5></h5>
                ...
                <button class="btn btn-lg btn-primary btn-block btn-signin" type="button" onClick="location.href='./31_staff_view_schedule.php';">View Schedule</button>
